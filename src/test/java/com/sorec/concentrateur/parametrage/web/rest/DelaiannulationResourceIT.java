...
public class DelaiannulationResourceIT {
    ...
    public void createDelaiannulation() throws Exception {
        ...
        DelaiannulationDTO delaiannulationDTO = delaiannulationMapper.toDto(delaiannulation);
        restDelaiannulationMockMvc.perform(post("/api/delaiannulations")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(delaiannulationDTO)))
    ...
    public void updateDelaiannulation() throws Exception {
        ...
        updatedDelaiannulation
            ...
            .valeurdelaiannulation(UPDATED_VALEURDELAIANNULATION)
            .statut(UPDATED_STATUT);
        DelaiannulationDTO delaiannulationDTO = delaiannulationMapper.toDto(updatedDelaiannulation);

        restDelaiannulationMockMvc.perform(put("/api/delaiannulations")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(delaiannulationDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteDelaiannulation() throws Exception {
        ...
        restDelaiannulationMockMvc.perform(delete("/api/delaiannulations/{id}", delaiannulation.getId())
