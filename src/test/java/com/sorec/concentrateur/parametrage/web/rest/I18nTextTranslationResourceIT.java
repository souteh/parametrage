...
import com.sorec.concentrateur.parametrage.ParametrageApp;
 ...
 */
@SpringBootTest(classes = ParametrageApp.class)
...
public class I18nTextTranslationResourceIT {
    ...
    public void createI18nTextTranslation() throws Exception {
        ...
        I18nTextTranslationDTO i18nTextTranslationDTO = i18nTextTranslationMapper.toDto(i18nTextTranslation);
        restI18nTextTranslationMockMvc.perform(post("/api/i-18-n-text-translations")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(i18nTextTranslationDTO)))
    ...
    public void updateI18nTextTranslation() throws Exception {
        ...
        updatedI18nTextTranslation
            ...
            .translation(UPDATED_TRANSLATION)
            .i18nTextId(UPDATED_I_18_N_TEXT_ID);
        I18nTextTranslationDTO i18nTextTranslationDTO = i18nTextTranslationMapper.toDto(updatedI18nTextTranslation);

        restI18nTextTranslationMockMvc.perform(put("/api/i-18-n-text-translations")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(i18nTextTranslationDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteI18nTextTranslation() throws Exception {
        ...
        restI18nTextTranslationMockMvc.perform(delete("/api/i-18-n-text-translations/{id}", i18nTextTranslation.getId())
