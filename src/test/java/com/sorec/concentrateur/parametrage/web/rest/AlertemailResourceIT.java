...
public class AlertemailResourceIT {
    ...
    public void createAlertemail() throws Exception {
        ...
        AlertemailDTO alertemailDTO = alertemailMapper.toDto(alertemail);
        restAlertemailMockMvc.perform(post("/api/alertemails")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(alertemailDTO)))
    ...
    public void updateAlertemail() throws Exception {
        ...
        updatedAlertemail
            ...
            .objetalertemail(UPDATED_OBJETALERTEMAIL)
            .adressemaildiffusion(UPDATED_ADRESSEMAILDIFFUSION);
        AlertemailDTO alertemailDTO = alertemailMapper.toDto(updatedAlertemail);

        restAlertemailMockMvc.perform(put("/api/alertemails")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(alertemailDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteAlertemail() throws Exception {
        ...
        restAlertemailMockMvc.perform(delete("/api/alertemails/{id}", alertemail.getId())
