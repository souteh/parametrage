...
public class TypeterminalResourceIT {
    ...
    public void createTypeterminal() throws Exception {
        ...
        TypeterminalDTO typeterminalDTO = typeterminalMapper.toDto(typeterminal);
        restTypeterminalMockMvc.perform(post("/api/typeterminals")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(typeterminalDTO)))
    ...
    public void updateTypeterminal() throws Exception {
        ...
        updatedTypeterminal
            ...
            .codetypeterminal(UPDATED_CODETYPETERMINAL)
            .libelle(UPDATED_LIBELLE);
        TypeterminalDTO typeterminalDTO = typeterminalMapper.toDto(updatedTypeterminal);

        restTypeterminalMockMvc.perform(put("/api/typeterminals")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(typeterminalDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteTypeterminal() throws Exception {
        ...
        restTypeterminalMockMvc.perform(delete("/api/typeterminals/{id}", typeterminal.getId())
