...
public class AttributaireResourceIT {
    ...
    public void createAttributaire() throws Exception {
        ...
        AttributaireDTO attributaireDTO = attributaireMapper.toDto(attributaire);
        restAttributaireMockMvc.perform(post("/api/attributaires")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(attributaireDTO)))
    ...
    public void updateAttributaire() throws Exception {
        ...
        updatedAttributaire
            ...
            .libelle(UPDATED_LIBELLE)
            .codeattributaire(UPDATED_CODEATTRIBUTAIRE);
        AttributaireDTO attributaireDTO = attributaireMapper.toDto(updatedAttributaire);

        restAttributaireMockMvc.perform(put("/api/attributaires")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(attributaireDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteAttributaire() throws Exception {
        ...
        restAttributaireMockMvc.perform(delete("/api/attributaires/{id}", attributaire.getId())
