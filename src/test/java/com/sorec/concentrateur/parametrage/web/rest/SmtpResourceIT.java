...
public class SmtpResourceIT {
    ...
    public void createSmtp() throws Exception {
        ...
        // Create the Smtp
        SmtpDTO smtpDTO = smtpMapper.toDto(smtp);
        restSmtpMockMvc.perform(post("/api/smtps")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(smtpDTO)))
    ...
    public void updateSmtp() throws Exception {
        ...
        updatedSmtp
            ...
            .login(UPDATED_LOGIN)
            .password(UPDATED_PASSWORD);
        SmtpDTO smtpDTO = smtpMapper.toDto(updatedSmtp);

        restSmtpMockMvc.perform(put("/api/smtps")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(smtpDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteSmtp() throws Exception {
        ...
        // Delete the smtp
        restSmtpMockMvc.perform(delete("/api/smtps/{id}", smtp.getId())
