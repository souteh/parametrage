...
public class HypodromeResourceIT {
    ...
    public void createHypodrome() throws Exception {
        ...
        HypodromeDTO hypodromeDTO = hypodromeMapper.toDto(hypodrome);
        restHypodromeMockMvc.perform(post("/api/hypodromes")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(hypodromeDTO)))
    ...
    public void updateHypodrome() throws Exception {
        ...
        updatedHypodrome
            ...
            .abreviation(UPDATED_ABREVIATION)
            .pays(UPDATED_PAYS);
        HypodromeDTO hypodromeDTO = hypodromeMapper.toDto(updatedHypodrome);

        restHypodromeMockMvc.perform(put("/api/hypodromes")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(hypodromeDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteHypodrome() throws Exception {
        ...
        restHypodromeMockMvc.perform(delete("/api/hypodromes/{id}", hypodrome.getId())
