...
public class PaiementlotsResourceIT {
    ...
    public void createPaiementlots() throws Exception {
        ...
        PaiementlotsDTO paiementlotsDTO = paiementlotsMapper.toDto(paiementlots);
        restPaiementlotsMockMvc.perform(post("/api/paiementlots")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(paiementlotsDTO)))
    ...
    public void updatePaiementlots() throws Exception {
        ...
        updatedPaiementlots
            ...
            .lieuautorise(UPDATED_LIEUAUTORISE)
            .lieuannulation(UPDATED_LIEUANNULATION);
        PaiementlotsDTO paiementlotsDTO = paiementlotsMapper.toDto(updatedPaiementlots);

        restPaiementlotsMockMvc.perform(put("/api/paiementlots")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(paiementlotsDTO)))
            .andExpect(status().isOk());
    ...
    public void deletePaiementlots() throws Exception {
        ...
        restPaiementlotsMockMvc.perform(delete("/api/paiementlots/{id}", paiementlots.getId())
