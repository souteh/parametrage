...
public class ChoisitResourceIT {
    ...
    public void createChoisit() throws Exception {
        ...
        // Create the Choisit
        ChoisitDTO choisitDTO = choisitMapper.toDto(choisit);
        restChoisitMockMvc.perform(post("/api/choisits")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(choisitDTO)))
    ...
    public void updateChoisit() throws Exception {
        ...
        updatedChoisit
            .idproduit(UPDATED_IDPRODUIT);
        ChoisitDTO choisitDTO = choisitMapper.toDto(updatedChoisit);

        restChoisitMockMvc.perform(put("/api/choisits")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(choisitDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteChoisit() throws Exception {
        ...
        // Delete the choisit
        restChoisitMockMvc.perform(delete("/api/choisits/{id}", choisit.getId())
