...
public class CommandesensibleResourceIT {
    ...
    public void createCommandesensible() throws Exception {
        ...
        CommandesensibleDTO commandesensibleDTO = commandesensibleMapper.toDto(commandesensible);
        restCommandesensibleMockMvc.perform(post("/api/commandesensibles")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(commandesensibleDTO)))
    ...
    public void updateCommandesensible() throws Exception {
        ...
        updatedCommandesensible
            ...
            .codecommandesensible(UPDATED_CODECOMMANDESENSIBLE)
            .libellecommandesensible(UPDATED_LIBELLECOMMANDESENSIBLE);
        CommandesensibleDTO commandesensibleDTO = commandesensibleMapper.toDto(updatedCommandesensible);

        restCommandesensibleMockMvc.perform(put("/api/commandesensibles")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(commandesensibleDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteCommandesensible() throws Exception {
        ...
        restCommandesensibleMockMvc.perform(delete("/api/commandesensibles/{id}", commandesensible.getId())
