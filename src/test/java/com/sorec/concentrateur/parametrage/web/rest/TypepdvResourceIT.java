...
public class TypepdvResourceIT {
    ...
    public void createTypepdv() throws Exception {
        ...
        // Create the Typepdv
        TypepdvDTO typepdvDTO = typepdvMapper.toDto(typepdv);
        restTypepdvMockMvc.perform(post("/api/typepdvs")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(typepdvDTO)))
    ...
    public void updateTypepdv() throws Exception {
        ...
        updatedTypepdv
            ...
            .nbremaxterminaux(UPDATED_NBREMAXTERMINAUX)
            .plafondpostpaye(UPDATED_PLAFONDPOSTPAYE);
        TypepdvDTO typepdvDTO = typepdvMapper.toDto(updatedTypepdv);

        restTypepdvMockMvc.perform(put("/api/typepdvs")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(typepdvDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteTypepdv() throws Exception {
        ...
        // Delete the typepdv
        restTypepdvMockMvc.perform(delete("/api/typepdvs/{id}", typepdv.getId())
