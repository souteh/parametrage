...
import com.sorec.concentrateur.parametrage.service.ActionparamService;
import com.sorec.concentrateur.parametrage.web.rest.errors.BadRequestAlertException;
import com.sorec.concentrateur.parametrage.service.dto.ActionparamCriteria;
import com.sorec.concentrateur.parametrage.service.ActionparamQueryService;
...
/**
 * REST controller for managing {@link com.sorec.concentrateur.parametrage.domain.Actionparam}.
 */
@RestController
@RequestMapping("/api")
public class ActionparamResource {
    ...
    private static final String ENTITY_NAME = "parametrageActionparam";
