...
import com.sorec.concentrateur.parametrage.service.EtapeService;
import com.sorec.concentrateur.parametrage.web.rest.errors.BadRequestAlertException;
import com.sorec.concentrateur.parametrage.service.dto.EtapeCriteria;
import com.sorec.concentrateur.parametrage.service.EtapeQueryService;
...
/**
 * REST controller for managing {@link com.sorec.concentrateur.parametrage.domain.Etape}.
 */
@RestController
@RequestMapping("/api")
public class EtapeResource {
    ...
    private static final String ENTITY_NAME = "parametrageEtape";
