...
/**
 * REST controller for managing {@link com.sorec.concentrateur.parametrage.domain.Catonlinecanalenum}.
 */
@RestController
@RequestMapping("/api")
public class CatonlinecanalenumResource {
    ...
    private static final String ENTITY_NAME = "parametrageCatonlinecanalenum";
