...
import com.sorec.concentrateur.parametrage.service.PaysService;
...
import com.sorec.concentrateur.parametrage.service.PaysQueryService;
...
/**
 * REST controller for managing {@link com.sorec.concentrateur.parametrage.domain.Pays}.
 */
@RestController
@RequestMapping("/api")
public class PaysResource {
    ...
    private static final String ENTITY_NAME = "parametragePays";
