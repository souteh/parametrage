...
import com.sorec.concentrateur.parametrage.service.dto.VersionCriteria;
import com.sorec.concentrateur.parametrage.service.VersionQueryService;
...
/**
 * REST controller for managing {@link com.sorec.concentrateur.parametrage.domain.Version}.
 */
@RestController
@RequestMapping("/api")
public class VersionResource {
    ...
    private static final String ENTITY_NAME = "parametrageVersion";
     ...
     */
    @GetMapping("/versions")
    public ResponseEntity<List<VersionDTO>> getAllVersions(VersionCriteria criteria, Pageable pageable) {
