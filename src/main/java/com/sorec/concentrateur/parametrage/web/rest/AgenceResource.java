...
import com.sorec.concentrateur.parametrage.service.dto.AgenceCriteria;
import com.sorec.concentrateur.parametrage.service.AgenceQueryService;
...
/**
 * REST controller for managing {@link com.sorec.concentrateur.parametrage.domain.Agence}.
 */
@RestController
@RequestMapping("/api")
public class AgenceResource {
    ...
    private static final String ENTITY_NAME = "parametrageAgence";
