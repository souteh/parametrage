...
import com.sorec.concentrateur.parametrage.service.MessageerreurService;
import com.sorec.concentrateur.parametrage.web.rest.errors.BadRequestAlertException;
import com.sorec.concentrateur.parametrage.service.dto.MessageerreurCriteria;
import com.sorec.concentrateur.parametrage.service.MessageerreurQueryService;
...
/**
 * REST controller for managing {@link com.sorec.concentrateur.parametrage.domain.Messageerreur}.
 */
@RestController
@RequestMapping("/api")
public class MessageerreurResource {
    ...
    private static final String ENTITY_NAME = "parametrageMessageerreur";
