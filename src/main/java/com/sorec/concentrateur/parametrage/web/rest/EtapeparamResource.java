...
import com.sorec.concentrateur.parametrage.service.EtapeparamService;
import com.sorec.concentrateur.parametrage.web.rest.errors.BadRequestAlertException;
import com.sorec.concentrateur.parametrage.service.dto.EtapeparamCriteria;
import com.sorec.concentrateur.parametrage.service.EtapeparamQueryService;
...
/**
 * REST controller for managing {@link com.sorec.concentrateur.parametrage.domain.Etapeparam}.
 */
@RestController
@RequestMapping("/api")
public class EtapeparamResource {
    ...
    private static final String ENTITY_NAME = "parametrageEtapeparam";
