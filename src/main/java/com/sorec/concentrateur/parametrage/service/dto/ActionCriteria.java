...
/**
 * Criteria class for the {@link com.sorec.concentrateur.parametrage.domain.Action} entity. This class is used
 * in {@link com.sorec.concentrateur.parametrage.web.rest.ActionResource} to receive all the possible filtering options from
