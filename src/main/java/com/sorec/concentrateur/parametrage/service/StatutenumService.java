...
@Service
@Transactional
public class StatutenumService {

    private final Logger log = LoggerFactory.getLogger(StatutenumService.class);

    private final StatutenumRepository statutenumRepository;

    public StatutenumService(StatutenumRepository statutenumRepository) {
