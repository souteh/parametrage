...
/**
 * Criteria class for the {@link com.sorec.concentrateur.parametrage.domain.Etape} entity. This class is used
 * in {@link com.sorec.concentrateur.parametrage.web.rest.EtapeResource} to receive all the possible filtering options from
