package com.sorec.concentrateur.parametrage.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("parametrage");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("parametrage");
        ...
        config.getMapConfigs().put("com.sorec.concentrateur.parametrage.domain.*", initializeDomainMapConfig(jHipsterProperties));
